...
function e(e) {
  t: {
    for (var n = ['CLOSURE_FLAGS'], r = t, i = 0; i < n.length; i++)
      if (null == (r = r[n[i]])) {
        n = null;
        break t;
      }
  ...
  return (
    (function (t, e) {
      ...
      for (var r = 0; ;) {
        ...
        (e((i << 2) | (s >> 4)),
          64 != o &&
            (e(((s << 4) & 240) | (o >> 2)), 64 != a && e(((o << 6) & 192) | a)));
      }
    })(t, function (t) {
      r[i++] = t;
    }),
...
function N(t) {
  U(O);
  var e = t.g;
  return null == (e = null == e || M(e) ? e : 'string' == typeof e ? R(e) : null)
    ? e
    : (t.g = e);
}
var B = class {
...
function X(t) {
  if ('string' == typeof t) return { buffer: R(t), P: !1 };
  ...
  if (t.constructor === B) return { buffer: N(t) || C(), P: !0 };
  if (t instanceof Uint8Array)
    return { buffer: new Uint8Array(t.buffer, t.byteOffset, t.byteLength), P: !1 };
  throw Error(
...
function nt(t) {
  if (16 > t.length) $(Number(t));
    ...
    ((t = BigInt(t)),
      (K = Number(t & BigInt(4294967295)) >>> 0),
      (Y = Number((t >> BigInt(32)) & BigInt(4294967295))));
  else {
    const e = +('-' === t[0]);
    Y = K = 0;
    const n = t.length;
    for (let r = e, i = ((n - e) % 6) + e; i <= n; r = i, i += 6) {
      ...
      ((Y *= 1e6),
        (K = 1e6 * K + e),
        4294967296 <= K && ((Y += Math.trunc(K / 4294967296)), (Y >>>= 0), (K >>>= 0)));
    }
    if (e) {
      const [t, e] = rt(K, Y);
      ((K = t), (Y = e));
...
function _t(t, e, n) {
  const r = t.g.l,
    ...
    s = t.g.g + i;
  let o = s - r;
  if ((0 >= o && ((t.g.l = s), n(e, t, void 0, void 0, void 0), (o = s - t.g.g)), o))
    throw Error(
...
function vt(t) {
  ...
  if (((t = t.h), o)) {
    var h,
      c = t;
    ((h = s) || (h = s = new TextDecoder('utf-8', { fatal: !0 })),
      (e = a + e),
    ...
    : (t, e) => {
        void 0 !== t.g
          ...
          : Object.defineProperties(t, {
              g: { value: e, configurable: !0, writable: !0, enumerable: !1 },
            });
      },
  Kt = Vt
    ? (t, e) => {
...
function oe(t) {
  return (
    null !== t && 'object' == typeof t && !Array.isArray(t) && t.constructor === Object
  );
}
function ae(t, e, n) {
  if (null != t)
...
function he(t, e, n) {
  ...
  return (
    !!(1 & r) ||
    (!(!e || !(Array.isArray(e) ? e.includes(n) : e.has(n))) && (Jt(t, 1 | r), !0))
  );
}
const ce = [];
function ue(t) {
...
var Ke = class extends He {
  constructor(t, e, n = We, r = We) {
    ...
    for (let s = 0; s < t.length; s++) {
      const o = t[s],
        a = n(o[0], !1, !0);
      let h = o[1];
      (e ? void 0 === h && (h = null) : (h = r(o[1], !1, !0, void 0, void 0, i)),
        super.set(a, h));
    }
  }
  oa(t = $e) {
  ...
  Oa(t) {
    ...
    ((t = t[1]),
      (t = this.U ? (void 0 === t ? null : t) : this.Z(t, !1, !0, void 0, !1, this.N)),
      super.set(e, t));
  }
  has(t) {
  ...
  get(t) {
    ...
    if (void 0 !== e) {
      var n = this.U;
      return n
        ? ((n = this.Z(e, !1, !0, n, this.ta, this.N)) !== e && super.set(t, n), n)
        : e;
    }
  }
  na() {
...
function Qe(t, e, n, r, i) {
  if (null != t) {
    if (Array.isArray(t))
      t = he(t, void 0, 0) ? void 0 : i && 2 & $t(t) ? t : tn(t, e, n, void 0 !== r, i);
    else if (oe(t)) {
      const s = {};
    ...
    if (Array.isArray(t)) {
      ...
      return (
        2 & r ||
          ...
          (t = e ? Jt(t, -12293 & (34 | r)) : tn(t, rn, 4 & r ? te : n, !0, !0))),
        t
      );
    }
    return (
      t.X === re
        ? ((n = t.s), (t = 2 & (r = qt(n)) ? t : sn(t, n, r, !0)))
        : t instanceof Ke &&
          !(2 & t.N) &&
          ((n = Zt(t.Y(rn))), (t = new Ke(n, t.U, t.S, t.Z))),
      t
    );
  }
}
...
function pn(t, e, n, r, i) {
  ...
  let c = $t(o);
  return (
    0 !== c || !h || s || a ? 1 & c || ((c |= 1), Jt(o, c)) : ((c |= 33), Jt(o, c)),
    s
      ? ((t = !1), 2 & c || (Zt(o), (t = !!(4 & c))), (r || t) && Object.freeze(o))
      : ((s = !!(2 & c) || !!(2048 & c)),
        r && s
          ? ((o = Gt(o)), (r = 1), h && !a && (r |= 32), Jt(o, r), fn(t, e, n, o, i))
          : a && 32 & c && !s && Kt(o, 32)),
    o
  );
}
...
function yn(t, e, n) {
  ...
  return (
    En(a) ||
      ((n = a),
      (a = (t = 1 === s || (4 === s && !!(32 & a))) ? Yt(a, 2, !0) : Un(a, i, !1)) !==
        n && Jt(o, a),
      t && Object.freeze(o)),
    2 === s &&
      En(a) &&
      ((o = Gt(o)), (a = Un((a = In(a, i)), i, !1)), Jt(o, a), fn(r, i, e, o)),
    o
  );
}
function _n(t, e, n) {
...
function Tn(t, e, n) {
  {
    ...
    if ((ue(h), null == n)) fn(a, h, e);
      ...
      if (((r = !o) && (r = !1), hn(t, i)))
        for (
          i = 21, o && ((n = Gt(n)), (s = 0), (i = Un((i = In(i, h)), h, !0))), t = 0;
          t < n.length;
          t++
        )
          n[t] = Re(n[t]);
      (r && ((n = Gt(n)), (s = 0), (i = Un((i = In(i, h)), h, !0))),
        i !== s && Jt(n, i),
        fn(a, h, e, n));
    }
  }
...
function Mn(t, e, n, r, i, s) {
  ...
  if (s && !(8 & h || (!a.length && (1 === o || (4 === o && 32 & h))))) {
    for (
      En(h) && ((a = Gt(a)), (h = In(h, e)), (e = fn(t, e, r, a))), n = a, s = h, u = 0;
      u < n.length;
      u++
    )
      (h = n[u]) !== (l = an(h)) && (n[u] = l);
  ...
  return (
    En(h) ||
      ((n = h),
      (h = (s = 1 === o || (4 === o && !!(32 & h)))
        ? Yt(h, !a.length || (16 & h && (!c || 32 & h)) ? 2 : 2048, !0)
        : Un(h, e, i)) !== n && Jt(a, h),
      s && Object.freeze(a)),
    2 === o &&
      En(h) &&
      ((a = Gt(a)), (h = Un((h = In(h, e)), e, i)), Jt(a, h), fn(t, e, r, a)),
    a
  );
}
function Pn(t, e, n) {
...
function Kn(t, e, n) {
  ...
  for (
    h = +!!(512 & i) - 1;
    0 < t &&
    ((n = e[(c = t - 1)]), (c -= h), null == n || he(n, r, c) || (se(n) && 0 === n.size));
    t--
  )
    o = !0;
      ...
      : (t, e) => {
          for (; mt(e) && 4 != e.h;) {
            ...
            (s && s(e, t, i)) ||
              ((i = (s = e).l),
              yt(s),
              s.ia ? (s = void 0) : ((o = s.g.g - i), (s.g.g = i), (s = pt(s.g, o))),
              (i = t),
              s && ((de ||= Symbol()), (o = i[de]) ? o.push(s) : (i[de] = [s])));
          }
...
function ar(t, e, n, r, i = or) {
  ...
  o &&
    ...
    ((e.ea = o),
    'function' == typeof (o = t[++s]) && ((e.l = o), (e.m = t[++s]), (o = t[++s])));
  const a = {};
  ...
  for (h = 1; void 0 !== o;) {
    ...
    for (
      u = h + 1, 'number' == typeof (o = t[++s]) && 0 > o && ((u -= o), (o = t[++s]));
      h < u;
      h++
    ) {
      const t = a[h];
...
function Er(t, e, n) {
  ...
  if (256 & r) {
    r = t[s - 1];
    for (let t in r)
      ((i = +t), Number.isNaN(i) || (null != (s = r[t]) && (a = vr(n, i)) && a(e, s, i)));
  }
  if ((t = de ? t[de] : void 0))
    for (Ct(e, e.g.end()), n = 0; n < t.length; n++) Ct(e, N(t[n]) || C());
}
function wr(t, e) {
...
var kr = Ar(
  function (t, e, n, r, i) {
    return (
      2 === t.h &&
      ((t = _t(t, Be([void 0, void 0], r), i)),
      ue((r = qt(e))),
      (i = ln(e, r, n)) instanceof Ke
        ? 0 != (2 & i.N)
          ? ((i = i.Y()).push(t), fn(e, r, n, i))
          : i.Oa(t)
        : Array.isArray(i)
          ? (2 & $t(i) && fn(e, r, n, (i = wn(i))), i.push(t))
          : fn(e, r, n, [t]),
      !0)
    );
  },
...
function Mr(t, e, n) {
  null !=
    (e = null == e || 'string' == typeof e || M(e) || e instanceof B ? e : void 0) &&
    Dt(t, n, X(e).buffer);
}
function Pr(t, e, n) {
  return (
    (5 === t.h || 2 === t.h) &&
    ((e = pn(e, qt(e), n, 2, !1)), 2 == t.h ? wt(t, ct, e) : e.push(ct(t.g)), !0)
  );
}
var Cr,
  Or = wr(
    ...
    function (t, e, n) {
      null != (e = ve(e)) &&
        (Ot(t, n, 1),
        (t = t.g),
        (n = z ||= new DataView(new ArrayBuffer(8))).setFloat64(0, +e, !0),
        (K = n.getUint32(0, !0)),
        (Y = n.getUint32(4, !0)),
        Pt(t, K),
        Pt(t, Y));
  ...
  Vr = Tr(
    function (t, e, n) {
      return (
        (0 === t.h || 2 === t.h) &&
        ((e = pn(e, qt(e), n, 2, !1)), 2 == t.h ? wt(t, ot, e) : e.push(ot(t.g)), !0)
      );
    },
    function (t, e, n) {
...
Cr = new Bt(
  function (t, e, n, r, i) {
    ...
    return (
      (s = qt(e)),
      4 & $t(o) && ((o = Gt(o)), Jt(o, -2079 & (1 | $t(o))), fn(e, s, n, o)),
      o.push(r),
      _t(t, r, i),
      !0
    );
...
var Jr = Ar(function (t, e, n, r, i, s) {
  ...
  Qr = Tr(
    function (t, e, n) {
      return (
        (0 === t.h || 2 === t.h) &&
        ((e = pn(e, qt(e), n, 2, !1)), 2 == t.h ? wt(t, at, e) : e.push(at(t.g)), !0)
      );
    },
    function (t, e, n) {
      if (null != (e = $n(be, e)))
  ...
  ei = Tr(
    function (t, e, n) {
      return (
        (0 === t.h || 2 === t.h) &&
        ((e = pn(e, qt(e), n, 2, !1)), 2 == t.h ? wt(t, ut, e) : e.push(ot(t.g)), !0)
      );
    },
    function (t, e, n) {
      if (null != (e = $n(Ae, e)) && e.length) {
...
_i[336783863] = [
  ...
  -1,
  jr,
  [0, [1, 2, 3, 4, 5, 6], Jr, gi, Jr, di, Jr, fi, Jr, mi, Jr, ci, Jr, [0, Yr]],
  hi,
  Hr,
  [0, [1, 3], [2, 4], Jr, [0, Vr], -1, Jr, [0, zr], -1, Cr, [0, Yr, -1]],
  Yr,
];
var Ei = [0, Kr, Wr],
    ...
    g() {
      ...
      return (
        (t = (function (t, e, n) {
          ...
          return (
            s || (64 & $t(n) ? Kt(n, 32) : 32 & e && zt(n, 32)),
            fn(t, e, 2, (r = new Ke(n, r, Oe, void 0)), !1),
            r
          );
        })(t, e, ln(t, e, 2))),
        null == t || (!n && bo && (t.ta = !0)),
...
function Po(t, e) {
  return (
    ...
    void 0 !== t.maxResults ? Xn(e, 2, t.maxResults) : 'maxResults' in t && dn(e, 2),
    void 0 !== t.scoreThreshold
      ? Hn(e, 3, t.scoreThreshold)
...
function Qo(t, e) {
  ...
  ('string' == typeof e
    ? (dn(n, 2, Me(e)), dn(n, 1))
    : e instanceof Uint8Array && (dn(n, 1, ae(e, !1, !1)), dn(n, 2)),
    Cn(t.baseOptions, 0, 1, n));
}
function ta(t) {
  try {
    const e = t.K.length;
    ...
    if (1 < e)
      throw Error('Encountered multiple errors: ' + t.K.map((t) => t.message).join(', '));
  } finally {
    t.K = [];
  }
}
...
var sa = class {
  ...
  l(t, e = !0) {
    if (e) {
      ...
      if (!(
        Rn(this.baseOptions, Ms, 1)?.g() ||
        Rn(this.baseOptions, Ms, 1)?.h() ||
      ...
      if (
        ((function (t, e) {
          ...
          ('delegate' in e &&
            ('GPU' === e.delegate
              ? ((e = n), (r = new li()), On(e, 2, Rs, r))
              : ((e = n), (r = new pi()), On(e, 4, Rs, r))),
            Cn(t.baseOptions, 0, 3, n));
        })(this, e),
        e.modelAssetPath)
      )
...
function la(t, e, n, r) {
  return (
    ua(t, e),
    t.h || (t.m(), t.D()),
    n ? (t.v || (t.v = ca(t, !0)), (n = t.v)) : (t.A || (t.A = ca(t, !1)), (n = t.A)),
    e.useProgram(t.h),
    n.bind(),
    t.l(),
    (t = r()),
...
function fa(t, e, n) {
  (ua(t, e),
    t.u || (t.u = oa(e.createFramebuffer(), 'Failed to create framebuffe.')),
...
var ga = class {
  ...
  m() {
    ...
    if (
      ...
      (this.aa = ha(this, this.H(), t.FRAGMENT_SHADER)),
...
var ma = class extends ga {
    ...
    D() {
      ...
      (t.activeTexture(t.TEXTURE1),
        (this.C = da(this, t, t.LINEAR)),
        t.activeTexture(t.TEXTURE2),
        (this.j = da(this, t, t.NEAREST)));
    }
    m() {
      super.m();
      const t = this.g;
      ((this.M = oa(
        ...
        (this.L = oa(t.getUniformLocation(this.h, 'maskTexture'), 'Uniform location')));
    }
    l() {
      super.l();
      const t = this.g;
  ...
  ya = class extends ga {
    ...
    m() {
      super.m();
      const t = this.g;
      ((this.L = oa(t.getUniformLocation(this.h, 'defaultTexture'), 'Uniform location')),
        (this.M = oa(t.getUniformLocation(this.h, 'overlayTexture'), 'Uniform location')),
        (this.I = oa(t.getUniformLocation(this.h, 'maskTexture'), 'Uniform location')));
    }
    l() {
      super.l();
      const t = this.g;
...
function ba(t) {
  ...
  let n = _a(t, 2);
  return (
    n || ((n = da(Aa(t), e, t.m ? e.LINEAR : e.NEAREST)), t.g.push(n), (t.j = !0)),
...
var xa,
  Sa = class {
    ...
    ka() {
      return (
        (e = _a((t = this), 0)) ||
          ((e = va(t)), (e = new Uint8Array(e.map((t) => 255 * t))), t.g.push(e)),
        e
      );
      var t, e;
    }
        ...
        if (e instanceof Uint8Array) n = new Uint8Array(e);
          ...
          if (!(e instanceof WebGLTexture)) throw Error(`Type is not supported: ${e}`);
          {
            const t = wa(this),
              e = Aa(this);
            (t.activeTexture(t.TEXTURE1),
              (n = da(e, t, this.m ? t.LINEAR : t.NEAREST)),
...
((Sa.prototype.close = Sa.prototype.close),
  (Sa.prototype.clone = Sa.prototype.clone),
  (Sa.prototype.getAsWebGLTexture = Sa.prototype.O),
  (Sa.prototype.getAsFloat32Array = Sa.prototype.ja),
  (Sa.prototype.getAsUint8Array = Sa.prototype.ka),
  (Sa.prototype.hasWebGLTexture = Sa.prototype.R),
  (Sa.prototype.hasFloat32Array = Sa.prototype.la),
  (Sa.prototype.hasUint8Array = Sa.prototype.Ha));
var La = 250;
const Fa = { color: 'white', lineWidth: 4, radius: 6 };
function Ra(t) {
  return { ...Fa, fillColor: (t = t || {}).color, ...t };
}
function Ma(t, e) {
  ...
  za(t, e, n) {
    if (t && e) {
      ...
      for (const o of e) {
        ...
        (e &&
          a &&
          ((r.strokeStyle = Ma(n.color, { index: s, from: e, to: a })),
          (r.lineWidth = Ma(n.lineWidth, { index: s, from: e, to: a })),
  ...
  xa(t, e, n = [0, 0, 0, 255]) {
    this.l
      ? (function (t, e, n, r) {
          ...
          Ia(t, e, (e) => {
            (Ua(t, e, n, r),
              (e = Ca(t)).drawImage(i.canvas, 0, 0, e.canvas.width, e.canvas.height));
          });
        })(this, t, n, e)
      : Ua(this, t.O(), n, e);
  }
...
function Ha(t) {
  ...
  let n = Ba(t, 2);
  return (
    n || ((n = da(Xa(t), e)), t.g.push(n), (t.m = !0)),
    e.bindTexture(e.TEXTURE_2D, n),
    n
  );
}
...
var Ka = class {
  ...
  Da() {
    var t = Ba(this, 1);
    return (
      t || (ja(this), Ha(this), (t = za(this)), Wa(this), this.g.push(t), (this.j = !0)),
      t
    );
  }
  O() {
...
const qa = (function (t) {
  ...
  ((Ja = class {
    ...
    addAudioToStreamWithShape(t, e, n, r, i) {
      const s = 4 * t.length;
      (this.h !== s &&
        (this.g && this.i._free(this.g), (this.g = this.i._malloc(s)), (this.h = s)),
...
function th(t, e, n, r) {
  if (t.V) {
    ...
    if (n?.regionOfInterest) {
      ...
      (Hn(s, 1, (i.left + i.right) / 2),
        Hn(s, 2, (i.top + i.bottom) / 2),
        Hn(s, 4, i.right - i.left),
        Hn(s, 3, i.bottom - i.top));
    } else (Hn(s, 1, 0.5), Hn(s, 2, 0.5), Hn(s, 4, 1), Hn(s, 3, 1));
    if (n?.rotationDegrees) {
      if (0 != n?.rotationDegrees % 90)
        throw Error('Expected rotation to be a multiple of 90°.');
      if (
        (Hn(s, 5, (-Math.PI * n.rotationDegrees) / 180), 0 != n?.rotationDegrees % 180)
      ) {
        const [t, r] = zo(e);
...
var ih = class extends sa {
  ...
  l(t, e = !0) {
    if (
      ('runningMode' in t &&
        Vn(this.baseOptions, 2, !!t.runningMode && 'IMAGE' !== t.runningMode),
...
var sh = class extends ih {
  constructor(t, e) {
    (super(new Za(t, e), 'image_in', 'norm_rect_in', !1),
      (this.j = { detections: [] }),
      Cn((t = this.h = new Is()), 0, 1, (e = new Cs())),
      Hn(this.h, 2, 0.5),
      Hn(this.h, 3, 0.3));
  }
  get baseOptions() {
  ...
  o(t) {
    return (
      'minDetectionConfidence' in t && Hn(this.h, 2, t.minDetectionConfidence ?? 0.5),
      'minSuppressionThreshold' in t && Hn(this.h, 3, t.minSuppressionThreshold ?? 0.3),
      this.l(t)
    );
  }
  F(t, e) {
    return ((this.j = { detections: [] }), eh(this, t, e), this.j);
  }
  G(t, e, n) {
    return ((this.j = { detections: [] }), nh(this, t, n, e), this.j);
  }
  m() {
    var t = new Di();
...
((sh.prototype.detectForVideo = sh.prototype.G),
  (sh.prototype.detect = sh.prototype.F),
  (sh.prototype.setOptions = sh.prototype.o),
  (sh.createFromModelPath = async function (t, e) {
    return Qa(sh, t, { baseOptions: { modelAssetPath: e } });
  }),
  (sh.createFromModelBuffer = function (t, e) {
    return Qa(sh, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
function mh(t) {
  t.u = { faceLandmarks: [], faceBlendshapes: [], facialTransformationMatrixes: [] };
}
var yh = class extends ih {
  constructor(t, e) {
    (super(new Za(t, e), 'image_in', 'norm_rect', !1),
      ...
      Cn((t = this.h = new Hs()), 0, 1, (e = new Cs())),
      (this.H = new Vs()),
      Cn(this.h, 0, 3, this.H),
      (this.j = new Is()),
      Cn(this.h, 0, 2, this.j),
      Xn(this.j, 4, 1),
      Hn(this.j, 2, 0.5),
      Hn(this.H, 2, 0.5),
      Hn(this.h, 4, 0.5));
  ...
  o(t) {
    return (
      ...
      'minFaceDetectionConfidence' in t &&
        Hn(this.j, 2, t.minFaceDetectionConfidence ?? 0.5),
      'minTrackingConfidence' in t && Hn(this.h, 4, t.minTrackingConfidence ?? 0.5),
      'minFacePresenceConfidence' in t &&
        Hn(this.H, 2, t.minFacePresenceConfidence ?? 0.5),
  ...
  m() {
    ...
    Wn(e, zs, this.h);
    const n = new Li();
    (ki(n, 'mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph'),
      xi(n, 'IMAGE:image_in'),
      xi(n, 'NORM_RECT:norm_rect'),
      ...
      this.outputFaceBlendshapes &&
        ...
        this.g.attachProtoVectorListener('blendshapes', (t, e) => {
          if (this.outputFaceBlendshapes)
            for (const e of t)
              ((t = Wi(e)), this.u.faceBlendshapes.push(Co(t.g() ?? [])));
          ea(this, e);
        }),
...
((yh.prototype.detectForVideo = yh.prototype.G),
  (yh.prototype.detect = yh.prototype.F),
  (yh.prototype.setOptions = yh.prototype.o),
  (yh.createFromModelPath = function (t, e) {
    return Qa(yh, t, { baseOptions: { modelAssetPath: e } });
  }),
  (yh.createFromModelBuffer = function (t, e) {
    return Qa(yh, t, { baseOptions: { modelAssetBuffer: e } });
  }),
  (yh.createFromOptions = function (t, e) {
    return Qa(yh, t, e);
  }),
  (yh.FACE_LANDMARKS_LIPS = oh),
  (yh.FACE_LANDMARKS_LEFT_EYE = ah),
  (yh.FACE_LANDMARKS_LEFT_EYEBROW = hh),
  (yh.FACE_LANDMARKS_LEFT_IRIS = ch),
  (yh.FACE_LANDMARKS_RIGHT_EYE = uh),
  (yh.FACE_LANDMARKS_RIGHT_EYEBROW = lh),
  (yh.FACE_LANDMARKS_RIGHT_IRIS = dh),
  (yh.FACE_LANDMARKS_FACE_OVAL = fh),
  (yh.FACE_LANDMARKS_CONTOURS = ph),
  (yh.FACE_LANDMARKS_TESSELATION = gh));
var _h = class extends ih {
  constructor(t, e) {
    (super(new Za(t, e), 'image_in', 'norm_rect', !0),
      Cn((t = this.j = new Ks()), 0, 1, (e = new Cs())));
  }
  get baseOptions() {
  ...
  Pa(t, e, n) {
    ...
    if (((this.h = 'function' == typeof e ? e : n), eh(this, t, r ?? {}), !this.h))
      return this.u;
  }
  m() {
    var t = new Di();
...
((_h.prototype.stylize = _h.prototype.Pa),
  (_h.prototype.setOptions = _h.prototype.o),
  (_h.createFromModelPath = function (t, e) {
    return Qa(_h, t, { baseOptions: { modelAssetPath: e } });
  }),
  (_h.createFromModelBuffer = function (t, e) {
    return Qa(_h, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var Ah = class extends ih {
  constructor(t, e) {
    (super(new Za(t, e), 'image_in', 'norm_rect', !1),
      ...
      (this.worldLandmarks = []),
      (this.handedness = []),
      Cn((t = this.v = new oo()), 0, 1, (e = new Cs())),
      (this.A = new io()),
      Cn(this.v, 0, 2, this.A),
      (this.u = new no()),
      Cn(this.A, 0, 3, this.u),
      (this.h = new to()),
      Cn(this.A, 0, 2, this.h),
      (this.j = new Zs()),
      Cn(this.v, 0, 3, this.j),
      Hn(this.h, 2, 0.5),
      Hn(this.A, 4, 0.5),
      Hn(this.u, 2, 0.5));
  }
  ...
  o(t) {
    if (
      ...
      'minHandDetectionConfidence' in t &&
        Hn(this.h, 2, t.minHandDetectionConfidence ?? 0.5),
      'minTrackingConfidence' in t && Hn(this.A, 4, t.minTrackingConfidence ?? 0.5),
      'minHandPresenceConfidence' in t &&
        Hn(this.u, 2, t.minHandPresenceConfidence ?? 0.5),
    ...
    return (
      t.customGesturesClassifierOptions
        ? (Cn(
            ...
            0,
            2,
            (r = Po(t.customGesturesClassifierOptions, Rn(this.j, $s, 4)?.h()))
          ),
          Cn(this.j, 0, 4, e))
        : void 0 === t.customGesturesClassifierOptions && Rn(this.j, $s, 4)?.g(),
      this.l(t)
    );
  }
  Ka(t, e) {
...
((Ah.prototype.recognizeForVideo = Ah.prototype.La),
  (Ah.prototype.recognize = Ah.prototype.Ka),
  (Ah.prototype.setOptions = Ah.prototype.o),
  (Ah.createFromModelPath = function (t, e) {
    return Qa(Ah, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Ah.createFromModelBuffer = function (t, e) {
    return Qa(Ah, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var kh = class extends ih {
  constructor(t, e) {
    (super(new Za(t, e), 'image_in', 'norm_rect', !1),
      ...
      (this.worldLandmarks = []),
      (this.handedness = []),
      Cn((t = this.j = new io()), 0, 1, (e = new Cs())),
      (this.u = new no()),
      Cn(this.j, 0, 3, this.u),
      (this.h = new to()),
      Cn(this.j, 0, 2, this.h),
      Xn(this.h, 3, 1),
      Hn(this.h, 2, 0.5),
      Hn(this.u, 2, 0.5),
      Hn(this.j, 4, 0.5));
  ...
  o(t) {
    return (
      ...
      'minHandDetectionConfidence' in t &&
        Hn(this.h, 2, t.minHandDetectionConfidence ?? 0.5),
      'minTrackingConfidence' in t && Hn(this.j, 4, t.minTrackingConfidence ?? 0.5),
      'minHandPresenceConfidence' in t &&
        Hn(this.u, 2, t.minHandPresenceConfidence ?? 0.5),
      this.l(t)
    );
  ...
  m() {
    ...
    Wn(e, ho, this.j);
    const n = new Li();
    (ki(n, 'mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph'),
      xi(n, 'IMAGE:image_in'),
      xi(n, 'NORM_RECT:norm_rect'),
      Si(n, 'LANDMARKS:hand_landmarks'),
      Si(n, 'WORLD_LANDMARKS:world_hand_landmarks'),
...
((kh.prototype.detectForVideo = kh.prototype.G),
  (kh.prototype.detect = kh.prototype.F),
  (kh.prototype.setOptions = kh.prototype.o),
  (kh.createFromModelPath = function (t, e) {
    return Qa(kh, t, { baseOptions: { modelAssetPath: e } });
  }),
  (kh.createFromModelBuffer = function (t, e) {
    return Qa(kh, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var Rh = class extends ih {
  constructor(t, e) {
    (super(new Za(t, e), 'input_frames_image', null, !1),
      ...
      Cn((t = this.A = new yo()), 0, 1, (e = new Cs())),
      (this.u = new no()),
      Cn(this.A, 0, 2, this.u),
      (this.aa = new uo()),
      Cn(this.A, 0, 3, this.aa),
      (this.j = new Is()),
      Cn(this.A, 0, 4, this.j),
      (this.H = new Vs()),
      Cn(this.A, 0, 5, this.H),
      (this.v = new fo()),
      Cn(this.A, 0, 6, this.v),
      (this.D = new go()),
      Cn(this.A, 0, 7, this.D),
      Hn(this.j, 2, 0.5),
      Hn(this.j, 3, 0.3),
      Hn(this.H, 2, 0.5),
      Hn(this.v, 2, 0.5),
  ...
  o(t) {
    return (
      ...
      'minFaceSuppressionThreshold' in t &&
        Hn(this.j, 3, t.minFaceSuppressionThreshold ?? 0.3),
      'minFacePresenceConfidence' in t &&
        Hn(this.H, 2, t.minFacePresenceConfidence ?? 0.5),
      'outputFaceBlendshapes' in t &&
        (this.outputFaceBlendshapes = !!t.outputFaceBlendshapes),
      'minPoseDetectionConfidence' in t &&
        Hn(this.v, 2, t.minPoseDetectionConfidence ?? 0.5),
      'minPoseSuppressionThreshold' in t &&
        Hn(this.v, 3, t.minPoseSuppressionThreshold ?? 0.3),
      'minPosePresenceConfidence' in t &&
        Hn(this.D, 2, t.minPosePresenceConfidence ?? 0.5),
      ...
      'minHandLandmarksConfidence' in t &&
        Hn(this.u, 2, t.minHandLandmarksConfidence ?? 0.5),
      this.l(t)
    );
  }
  F(t, e, n) {
  ...
  m() {
      ...
      (function (t, e) {
        if (null != e)
          if (Array.isArray(e)) dn(t, 2, tn(e, nn, void 0, void 0, !1));
            ...
            if (!('string' == typeof e || e instanceof B || M(e)))
              throw Error(
    ...
    const r = new Li();
    (ki(r, 'mediapipe.tasks.vision.holistic_landmarker.HolisticLandmarkerGraph'),
      Dn(r, 8, oi, n),
      xi(r, 'IMAGE:input_frames_image'),
      ...
      this.outputFaceBlendshapes &&
        ...
        this.g.attachProtoListener('extra_blendshapes', (t, e) => {
          ...
          (this.outputFaceBlendshapes && ((t = Wi(t)), n.push(Co(t.g() ?? []))),
            ea(this, e));
        }),
...
((Rh.prototype.detectForVideo = Rh.prototype.G),
  (Rh.prototype.detect = Rh.prototype.F),
  ...
  (Rh.HAND_CONNECTIONS = vh),
  (Rh.POSE_CONNECTIONS = xh),
  (Rh.FACE_LANDMARKS_LIPS = oh),
  (Rh.FACE_LANDMARKS_LEFT_EYE = ah),
  (Rh.FACE_LANDMARKS_LEFT_EYEBROW = hh),
  (Rh.FACE_LANDMARKS_LEFT_IRIS = ch),
  (Rh.FACE_LANDMARKS_RIGHT_EYE = uh),
  (Rh.FACE_LANDMARKS_RIGHT_EYEBROW = lh),
  (Rh.FACE_LANDMARKS_RIGHT_IRIS = dh),
  (Rh.FACE_LANDMARKS_FACE_OVAL = fh),
  (Rh.FACE_LANDMARKS_CONTOURS = ph),
  (Rh.FACE_LANDMARKS_TESSELATION = gh));
var Mh = class extends ih {
  ...
  ua(t, e) {
    return ((this.j = { classifications: [] }), eh(this, t, e), this.j);
  }
  va(t, e, n) {
    return ((this.j = { classifications: [] }), nh(this, t, n, e), this.j);
  }
  m() {
    var t = new Di();
    ...
    Wn(e, vo, this.h);
    const n = new Li();
    (ki(n, 'mediapipe.tasks.vision.image_classifier.ImageClassifierGraph'),
      xi(n, 'IMAGE:input_image'),
      xi(n, 'NORM_RECT:norm_rect'),
      ...
      this.g.attachProtoListener('classifications', (t, e) => {
        ((this.j = (function (t) {
          const e = {
            classifications: Pn(t, ps, 1).map((t) =>
              Co(Rn(t, Xi, 4)?.g() ?? [], Bn(Nn(t, 2), 0), jn(t, 3))
            ),
          };
...
((Mh.prototype.classifyForVideo = Mh.prototype.va),
  (Mh.prototype.classify = Mh.prototype.ua),
  (Mh.prototype.setOptions = Mh.prototype.o),
  (Mh.createFromModelPath = function (t, e) {
    return Qa(Mh, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Mh.createFromModelBuffer = function (t, e) {
    return Qa(Mh, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var Ph = class extends ih {
  ...
  o(t) {
    ...
    return (
      (n = n ? n.clone() : new Ss()),
      void 0 !== t.l2Normalize ? Vn(n, 1, t.l2Normalize) : 'l2Normalize' in t && dn(n, 1),
      void 0 !== t.quantize ? Vn(n, 2, t.quantize) : 'quantize' in t && dn(n, 2),
      Cn(e, 0, 2, n),
      this.l(t)
    );
  }
          ...
          (this.embeddings = (function (t) {
            return {
              embeddings: Pn(t, Es, 1).map((t) => {
                const e = { headIndex: Bn(Nn(t, 3), 0) ?? -1, headName: jn(t, 4) ?? '' };
                if (void 0 !== Fn(t, _s, xn(t, 1)))
                  ((t = yn((t = Rn(t, _s, xn(t, 1))), 1, ve)),
...
((Ph.cosineSimilarity = function (t, e) {
  ...
  (Ph.prototype.embedForVideo = Ph.prototype.Ca),
  (Ph.prototype.embed = Ph.prototype.Ba),
  (Ph.prototype.setOptions = Ph.prototype.o),
  (Ph.createFromModelPath = function (t, e) {
    return Qa(Ph, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Ph.createFromModelBuffer = function (t, e) {
    return Qa(Ph, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var Uh = class extends ih {
  ...
  L() {
    !(function (t) {
      const e = Pn(t.fa(), Li, 1).filter((t) =>
        jn(t, 1).includes('mediapipe.tasks.TensorsToSegmentationCalculator')
      );
      if (((t.u = []), 1 < e.length))
        throw Error(
      ...
      1 === e.length &&
        (Rn(e[0], yi, 7)?.l()?.g() ?? new Map()).forEach((e, n) => {
          t.u[Number(n)] = jn(e, 1);
        });
    })(this);
  }
  ...
  m() {
    ...
    Wn(e, So, this.h);
    const n = new Li();
    (ki(n, 'mediapipe.tasks.vision.image_segmenter.ImageSegmenterGraph'),
      xi(n, 'IMAGE:image_in'),
      xi(n, 'NORM_RECT:norm_rect'),
      n.o(e),
      Oi(t, n),
...
((Uh.prototype.getLabels = Uh.prototype.Fa),
  (Uh.prototype.segmentForVideo = Uh.prototype.Na),
  (Uh.prototype.segment = Uh.prototype.ga),
  (Uh.prototype.setOptions = Uh.prototype.o),
  (Uh.createFromModelPath = function (t, e) {
    return Qa(Uh, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Uh.createFromModelBuffer = function (t, e) {
    return Qa(Uh, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var rc = class extends ih {
  ...
  ga(t, e, n, r) {
    ...
    const s = new Zh();
    var o = new Nh();
    if ((Xn(o, 1, 255), Cn(s, 0, 12, o), e.keypoint && e.scribble))
    ...
    if (e.keypoint) {
      ...
      for (a of ((o = new Jh()), e.scribble))
        (Vn((e = new $h()), 3, !0), Hn(e, 1, a.x), Hn(e, 2, a.y), Dn(o, 1, $h, e));
      On(s, 15, Qh, o);
    }
    (Dn(r, 1, Zh, s),
  ...
  m() {
    ...
    Wn(e, So, this.h);
    const n = new Li();
    (ki(n, 'mediapipe.tasks.vision.interactive_segmenter.InteractiveSegmenterGraph'),
      xi(n, 'IMAGE:image_in'),
      xi(n, 'ROI:roi_in'),
      xi(n, 'NORM_RECT:norm_rect_in'),
      n.o(e),
...
((rc.prototype.segment = rc.prototype.ga),
  (rc.prototype.setOptions = rc.prototype.o),
  (rc.createFromModelPath = function (t, e) {
    return Qa(rc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (rc.createFromModelBuffer = function (t, e) {
    return Qa(rc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
((ic.prototype.detectForVideo = ic.prototype.G),
  ...
  (ic.createFromModelPath = async function (t, e) {
...
var hc = class extends ih {
  constructor(t, e) {
    (super(new Za(t, e), 'image_in', 'norm_rect', !1),
      ...
      Cn((t = this.h = new Ro()), 0, 1, (e = new Cs())),
      (this.D = new go()),
      Cn(this.h, 0, 3, this.D),
      (this.v = new fo()),
      Cn(this.h, 0, 2, this.v),
      Xn(this.v, 4, 1),
      Hn(this.v, 2, 0.5),
      Hn(this.D, 2, 0.5),
      Hn(this.h, 4, 0.5));
  ...
  m() {
    ...
    Wn(e, Mo, this.h);
    const n = new Li();
    (ki(n, 'mediapipe.tasks.vision.pose_landmarker.PoseLandmarkerGraph'),
      xi(n, 'IMAGE:image_in'),
      xi(n, 'NORM_RECT:norm_rect'),
      ...
      this.outputSegmentationMasks &&
        ...
        this.g.da('segmentation_masks', (t, e) => {
          ((this.segmentationMasks = t.map((t) => rh(this, t, !0, !this.j))),
            ea(this, e));
        }),
...
((hc.prototype.detectForVideo = hc.prototype.G),
  (hc.prototype.detect = hc.prototype.F),
  (hc.prototype.setOptions = hc.prototype.o),
  (hc.createFromModelPath = function (t, e) {
    return Qa(hc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (hc.createFromModelBuffer = function (t, e) {
    return Qa(hc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
export {
  Na as DrawingUtils,
  sh as FaceDetector,
  yh as FaceLandmarker,
  _h as FaceStylizer,
  Xo as FilesetResolver,
  Ah as GestureRecognizer,
  kh as HandLandmarker,
  Rh as HolisticLandmarker,
  Mh as ImageClassifier,
  Ph as ImageEmbedder,
  Uh as ImageSegmenter,
  Ch as ImageSegmenterResult,
  rc as InteractiveSegmenter,
  Dh as InteractiveSegmenterResult,
  Ka as MPImage,
  Sa as MPMask,
  ic as ObjectDetector,
  hc as PoseLandmarker,
  ih as VisionTaskRunner,
};
